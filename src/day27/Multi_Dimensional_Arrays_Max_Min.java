...
public class Multi_Dimensional_Arrays_Max_Min {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(arr2D[0]));  // {1, 2, 3}=>returns int array
        System.out.println(Arrays.toString(arr2D[1]));// {4, 5, 6}=>returns int array

        // arr2D[0][2]  ==> 3
        System.out.println(arr2D[0][2]);   // 3==>returns int value

        // print 5: arr2D[1][1]
        System.out.println(arr2D[1][1]);  // 5==> retunrs int value


        System.out.println(Arrays.toString(arr2D[1])); //[4, 5, 6]=> Arrays.toString is only applicable to single dimensional arrays
